...
class StanfordCars(VisionDataset):
    ...
    def __init__(
        ...
        self._base_folder = pathlib.Path(root).expanduser() / "stanford_cars"
        ...
        self._cached_images = []
        if self._cache_ram:
            for image_path, _ in self._samples:
    ...
    def __getitem__(self, idx: int) -> Tuple[Any, Any]:
        ...
        if self._cache_ram:
            pil_image = self._cached_images[idx]
        else:
            pil_image = self._to_tensor(Image.open(image_path).convert("RGB"))
